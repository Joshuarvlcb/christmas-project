...
//1. Whats the problem
//find the smallest area square of wrapping paper

//Formula (2S + L) ( 2M + 2S)
//example
// 12 x 9 x 4 = (2*4 + 12) (2*9 + 2*4) = 20 * 26 = 520
// 	2 x 4 x 10 = (2*2 + 10) (2*4 + 2*2) = 14 * 12 = 188
...
//3.
//Whats the problem?
//find the smallest lenghth on question 2 and add them together
// 20 x 26
// 14 x 12
// The shortest sides from each were 20 and 12.
// Total length used was 20 + 12 = 32 feet
...
//4.
//Whats the probelm?
//presents wrapped need a bow
// 	3 x 6 x 9 = (3 + 6 + 3 + 6) + (3 + 9 + 3 + 9) + (3 * 6 * 9) make this formula

//what i need?
//i need to make a new formula same thing
const ribbonCalc = function () {
  let total = 0;
  let ribbon = 1;
